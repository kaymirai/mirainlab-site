...
(function () {
  ...
  function showResult() {
    ...
    let text = '受け取りPDFを開き、言葉選びからデザイン画像1枚の完成までを3ステップで進めましょう。';
    let link = 'free-gift.html';
    let label = 'スターターキットを見る';
    let plan = [
      '受け取りPDFを開き、全体の3ステップを確認する',
      '一覧から気になる言葉を1つ選ぶ',
      '商品案GPTのコピペ文で3案を出す',
      '初心者でも作りやすい商品案を1つ残す',
      '画像づくりGPTの入力例を使う',
    ...
    if (supportScore >= 3) {
      ...
      text = '3か月伴走で、商品選び・出品準備・改善を一緒に進める段階です。合うか不安な場合は90分相談で状況を整理できます。';
      link = 'mentor.html';
      label = '3か月伴走を見る';
      plan = [
        'いま止まっている画面と商品を1つに絞る',
